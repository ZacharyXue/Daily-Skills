...
**⚠️ 海外收入占比高的公司，先剔"汇率假摔"再看净利**：财务费用可能被汇兑损益放大/缩小，把一次性会计扰动误判成经营恶化。见 `references/forex-profit-trap.md`（财务费用=利息净额+汇兑；反推汇兑方法；剔汇兑后归母才是真实经营）。海尔/美的这类出海白电必查。
...
- **EPS 领先/滞后标签（2026-09 实证固化）**：脚本自动拉K线，对比近6月 EPS预测中位变化 vs 同期股价变化，输出三态：
  - `⚠️ 领先(机构已下修,股价未跌透,接刀风险)` — EPS 下修 >5% 但股价还没跌（信息链：分析师>市场，机构先跑）
  - `同步确认(机构下修,股价已跟跌)` — EPS 下修同时股价已跌
  - `跟随/中性` — EPS 横盘（与茅台/海尔/美的近3年实证一致：EPS预测大幅下修领先股价，覆盖/目标价跟随股价）
...
- **别把财务费用波动当经营变化**：海外收入占比高的公司（海尔/美的/出海制造），财务费用由负转正或骤增，先拆 `FINANCE_EXPENSE - (FE_INTEREST_EXPENSE - FE_INTEREST_INCOME)` 反推汇兑——汇兑是非经营性、随汇率波动，可剔除；利息净额稳定而波动全在汇兑 = "汇率假摔"，真实经营平稳（案例：海尔 2026中报，剔汇兑后 -14.3%→约-2%）。详见 `references/forex-profit-trap.md`。
