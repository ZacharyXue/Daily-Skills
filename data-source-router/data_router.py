...
def _register():
    ...
    return {
        ...
        "cn_stock_dividend": (lambda p: fin.cn_stock_dividend(p["secucode"], p.get("page", 12)), "eastmoney", TTL["cn_financial"], "T1"),
        "cn_stock_dividend_annual": (lambda p: fin.cn_stock_dividend_annual(p["secucode"], p.get("page", 24)), "eastmoney", TTL["cn_financial"], "T1"),
