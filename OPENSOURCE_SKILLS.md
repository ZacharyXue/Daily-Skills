...
> 本文件记录当前 Hermes 环境中使用的全部**开源（bundled）skill**，来源为 Hermes 内置 manifest。
> 自建 skill 见 [README.md](README.md) 索引表。
> 更新时间：2026-08-16，共 73 个。

## 清单

| Skill | manifest hash（前 12 位） |
|-------|--------------------------|
...
| hermes-agent | `531055b937ecfc8bf91e528a2d8e96ae` |
| hermes-agent-skill-authoring | `c3aebbef0762f3a39a2c3433eadb19f6` |
| hermes-desktop-plugins | `a31f90cb1be30b2e08b838ce2dcf8195` |
...
- 每次 Hermes 升级后运行 `cat ~/.hermes/skills/.bundled_manifest` 核对本清单
- 新增/删除开源 skill 时同步更新本文件